...
public class SacrilegePower extends BasePower {
    public static final String POWER_ID = makeID("SacrilegePower");
    private static final AbstractPower.PowerType TYPE = AbstractPower.PowerType.DEBUFF;
    private static final boolean TURN_BASED = true;

    public SacrilegePower(AbstractCreature owner, int amount) {
