...
import static scrollblade.ScrollbladeMod.characterPath;
import static scrollblade.ScrollbladeMod.makeID;

public class ScrollbladeCharacter extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("Scrollblade"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass SCROLLBLADE;
        @SpireEnum(name = "SCROLL") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "SCROLL") @SuppressWarnings("unused")
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new ScrollbladeCharacter(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
    ...
    public ScrollbladeCharacter() {
        super(getNames()[0], Meta.SCROLLBLADE,
    ...
    public AbstractPlayer newInstance() {
        ...
        return new ScrollbladeCharacter();
    }
}
