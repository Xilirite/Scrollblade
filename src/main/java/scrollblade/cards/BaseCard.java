package scrollblade.cards;

import basemod.BaseMod;
import basemod.abstracts.CustomCard;
import basemod.abstracts.DynamicVariable;
import scrollblade.ScrollbladeMod;
import scrollblade.util.CardStats;
import scrollblade.util.TriFunction;
...
import static scrollblade.util.GeneralUtils.removePrefix;
import static scrollblade.util.TextureLoader.getCardTextureString;


public abstract class BaseCard extends CustomCard {
    final private static Map<String, DynamicVariable> customVars = new HashMap<>();

    protected static String makeID(String name) { return ScrollbladeMod.makeID(name); }
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    ScrollbladeMod.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
