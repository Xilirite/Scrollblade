...
public class Strike extends BaseCard {
    ...
    private static final CardStats info = new CardStats(
            ScrollbladeCharacter.Meta.CARD_COLOR, //The card color. If you're making your own character, it'll look something like this. Otherwise, it'll be CardColor.RED or similar for a basegame character color.
